          ...
          <TitleSection>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card sx={{ maxWidth: matchesXS ? "100%" : 345, minHeight: matchesXS ? 250 : 290 }}>
                  <Box
                    sx={{
                      borderRadius: "5px",
                      width: "45px",
                  ...
                  <CardContent>
                    <Typography gutterBottom variant={matchesXS ? "h6" : matchesSM ? "h6" : "h5"} component="div">
                      {item.title}
                    </Typography>
                    <p  style={{fontSize: matchesXS ? ".9rem" : matchesSM ? ".8rem" : "1rem", lineHeight: matchesXS ? "15px" : matchesSM ? "17px" : "22px"}}>
                     {item.describtion}
                    </p>
                  </CardContent>
                </Card>
